...
variable "asg_name_prefix_template" {
  description = "Prefix name to Auto Scaling Grout Template"
  type        = string
  default     = "asg-template-poc-lendfront"
}
...
# 04_Security Groups resources

variable "sg_alb_name_poc" {
  description = "Security group name"
  type        = string
  default     = "sg-alb-poc-lendfront"
}

variable "sg_ec2_name_poc" {
  description = "Security group name"
  type        = string
  default     = "sg-ec2-poc-lendfront"
}


# 05_ELB resources

variable "alb_name_poc_lendfront" {
  description = "The name of the application load balancer"
  type        = string
  default     = "alb-app-lendfront"
}

variable "lb_tg_name" {
  description = "The name of the target group of the alb"
  type        = string
  default     = "tg-app-poc-lendfront"
}
